...
com \texttt{python code/run\_all.py --confirmatory}.
...
código contra suas fontes; e, por API, o Gemini~2.5~Pro, o DeepSeek-V3 e o
GPT-5.2-pro como revisores independentes das afirmações e da prosa do manuscrito,
cada um rodado em fornecedor diferente do que redigiu o trecho revisado. Após
