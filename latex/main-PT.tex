...
\noindent\textbf{Palavras-chave:} IA generativa no governo; informação
regulatória; confiabilidade da informação; gestão ambiental pública; apoio
algorítmico à decisão; modelos de linguagem de grande porte; Sul Global
...
\item \textbf{Vitor de Melo Dominski (Faculdade Descomplica):} Curadoria de Dados,
  Software, Análise Formal.
\item \textbf{Prof.\ Anibal Tavares de Azevedo (Unicamp):} Redação~--~Rascunho
...
\textbf{Como objeto e instrumento do estudo.} Modelos de linguagem são o objeto
...
\textbf{Na preparação do manuscrito.} Durante a preparação deste trabalho, os
