...
recommendation ($\delta=-0.47$), deepest on the national standard itself
...
leaving T1, which always had official ground truth, at exactly $0.367$.
...
predicts the specificity deficit at the full-sample magnitude ($\beta=+0.025$,
$p=6\times10^{-4}$). What that coefficient measures cannot be language. The claim
stops there: country representation is the operative channel for a gap measured in
