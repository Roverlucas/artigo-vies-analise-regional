...
model Cabra-Mistral~7B is the \emph{weakest} of all ($0.347$ versus $0.549$ for the rest; Mann-Whitney $p\approx 0$, Cliff's
...
The ten Global North countries average $0.570$ against
...
H1 tier gap        & $+5.1$~pp; OR $0.22$ on T1  & tier \\
\midrule
\multicolumn{3}{@{}l}{\emph{Supported, but not causally identified}} \\
\addlinespace[2pt]
H4 within country  & $\beta=+0.026$, $p=2\times10^{-8}$ & country coverage \\
\midrule
\multicolumn{3}{@{}l}{\emph{Not supported}} \\
\addlinespace[2pt]
H1 gradient        & $\rho=0.37$, $p=0.072$      & development \\
...
\addlinespace[2pt]
H5 open/closed     & $+13.3$~pp for closed       & access type \\
\bottomrule
\end{tabular}
