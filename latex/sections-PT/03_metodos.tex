...
afirmado é pontuado como fabricado. Bangladesh é pontuado contra o valor do diário
oficial de 2005, porque sua revisão de 2022 não pôde ser confirmada em texto
oficial acessível, e o Egito não tem chave alguma, porque o texto oficial em
árabe não pôde ser recuperado; o Egito fica, portanto, fora de T1 (56 células).
...
sucederam os 12,0), o registro armazena a escada inteira além do valor em vigor,
...
aritmética só consegue reproduzi-la com ruído. O código resolve 99.8\% das
células de T1 na análise (1.614 de 1.617), 56.3\% de T2 e 71.8\% de T3; uma
...
originais o déficit do Sul Global em T1 era 0.21 contra 0.38 sob o GPT-5-mini,
mas 0.37 contra 0.44 sob o Claude Haiku, uma diferença entre juízes tão grande
...
muda o veredito de código em 3,1\% das células e a média em 0,0001
