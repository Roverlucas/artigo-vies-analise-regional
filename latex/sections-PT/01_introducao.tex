...
ajuste fino ou verificação com humano no circuito, que exigem capacidade que a
maioria dos órgãos da nossa amostra do Sul Global não tem. Todas as consultas
...
\item \emph{As três correções de localização a que os órgãos recorrem,
  ...
  fluxo de trabalho. Nenhum funciona, e perguntar no idioma do próprio país
  reduz a acurácia em $\nnativa$ pontos percentuais, de forma mais acentuada
  para o idioma de corpus mais escasso.
\item \emph{Um desenho que separa quem é mal servido de por quê, e relata onde
  ...
  são colineares; dentro dos países, o contraste por tarefa que sugere um
  efeito de cobertura no nível da resposta não sobrevive à inferência no nível
  do país, e relatamos o mecanismo como não estabelecido. Documentamos também
