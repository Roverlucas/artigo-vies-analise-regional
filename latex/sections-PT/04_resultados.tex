...
todos (0.347 contra 0.549 para os demais;
...
H1 lacuna de camada & $+5.1$~pp; RC 0.22 em T1     & camada \\
\midrule
\multicolumn{3}{@{}l}{\emph{Sustentada, mas não identificada causalmente}} \\
\addlinespace[2pt]
H4 dentro do país   & $\beta=+0.026$, $p=2\times10^{-8}$ & cobertura do país \\
\midrule
\multicolumn{3}{@{}l}{\emph{Não sustentadas}} \\
\addlinespace[2pt]
H1 gradiente        & $\rho=0.37$, $p=0.072$       & desenvolvimento \\
H4 pré-especificada & proxy de corpus do idioma nulo & corpus do idioma \\
H6 persona          & DiD $+0.6$~pp, $p=0.27$      & --- \\
\midrule
\multicolumn{3}{@{}l}{\emph{Apenas descritiva}} \\
\addlinespace[2pt]
H5 aberto/fechado   & $+13.3$~pp para fechados     & tipo de acesso \\
\bottomrule
\end{tabular}
...
depende de um fato nacional. H4 dentro do país remove o confundimento no nível do
país por construção, o que não é identificação causal.
\end{minipage}
\end{table}
