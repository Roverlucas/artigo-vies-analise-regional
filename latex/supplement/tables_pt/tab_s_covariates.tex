...
\caption{Covariáveis dos países. IDH: UNDP HDR 2023--24 (dados de 2022). Joshi: classe de recurso linguístico do idioma oficial dominante~\citep{joshi2020state}. Medidas de corpus do Wikimedia/Wikidata (QID da entidade resolvível): comprimento em bytes do artigo em inglês, sitelinks do Wikidata (edições de idioma) e statements do Wikidata.\label{tab:s-covariates}}\\
\toprule
País & Camada & IDH & Joshi & Bytes wiki-EN & Sitelinks & Stmts WD \\
\midrule \endfirsthead
\toprule País & Camada & IDH & Joshi & Bytes wiki-EN & Sitelinks & Stmts WD \\ \midrule \endhead
