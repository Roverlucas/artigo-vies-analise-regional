...
\caption{Cobertura por país: camada (GN/GS), status de pré-registro (P = pré-registrado, 15 países; E = extensão post-registration), e respostas confirmatórias realizadas (inglês, idioma nativo, total).\label{tab:s-cov-country}}\\
\toprule
País & Camada & Conjunto & Inglês & Nativo & Total \\
\midrule \endfirsthead
\toprule País & Camada & Conjunto & Inglês & Nativo & Total \\ \midrule \endhead
