...
lines = [
 r"% AUTO-GENERATED by code/analysis/make_supplement_tables.py",
 r"\begin{longtable}{llp{3.0cm}lp{4.6cm}}",
 ...
 r"\toprule",
 r"Country & Value & Status & Type & Official source \\",
 r"\midrule \endfirsthead",
 r"\toprule Country & Value & Status & Type & Official source \\ \midrule \endhead",
]
