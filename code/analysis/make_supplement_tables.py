...
lines = [
 ...
 r"\caption{Coverage by country: tier (GN/GS), sample set (P = pre-specified 15; E = extension), and realized confirmatory responses (English, native-language, total).\label{tab:s-cov-country}}\\",
 r"\toprule",
