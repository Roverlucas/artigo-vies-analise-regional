...
antes: 'snapshots do Common Crawl sub-representam conteudo lusofono'

## Verbatim conferido

> "While much of the existing work has centered on English, there remains a gap in understanding how to construct effective training corpora for other languages... We apply them to build a new 120B token corpus in Portuguese"
